...
LGa = Window:AddTab({ Title = "Player", Icon = "" })
LGa:AddButton({
    Title = "Stop Tween",
    Callback = function()
        StopTween()
...
Main = Window:AddTab({ Title = "Farm Level", Icon = "" })
Main:AddParagraph({
     Title = "Main Farm",
     Content = string.rep("-", 21)
})
...
Volcanic = Window:AddTab({ Title = "Volcanic ", Icon = "" })
Volcanic:AddButton({
...
Button.Image = "rbxassetid://115253362129558"
