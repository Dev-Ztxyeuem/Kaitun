         ...
         delaytime = tick() 
             ...
             --   elseif  CheckSea(3) and cdkstuff1()  then 
                ...
                if CheckSea(3)  then
                        ...
                        repeat wait() pcall(function ()sexroblox:Cancel()end) to(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame) print("?") until checkNotify("GO") or not game.Players.LocalPlayer.Character:FindFirstChild"Head"
...
repeat wait ()
                                   ...
                                   until not potato or not potato.Character or not potato.Character:FindFirstChild"Humanoid" or not potato.Character:FindFirstChild"Head" or not skidymf(potato.Character) or game.Players.LocalPlayer.PlayerGui.Main.SafeZone.Visible or checkNotify"player" or moctui(3)
                                     dmlockskill = false
                                 end
                       ...
                       if  dimemi and grhsksjehjrjdjdjsks) > 3  then 
